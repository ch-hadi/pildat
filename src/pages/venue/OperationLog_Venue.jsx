...
export default function OperationLog_Venue() {
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ borderRadius: 4, margin: 0, textAlign: 'center' }}>List Of Venue Operation Logs</p>
      </div>
        ...
        <Container style={{ padding: 0, margin: 0 }}>
          ...
          <Card>
            <UserListToolbar
              ...
              placeholder="Search Operation log.."
              filterName={filterName}
              onFilterName={handleFilterByName}
            />

            <Scrollbar style={{ padding: 0, margin: 0 }}>
