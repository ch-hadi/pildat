...
const TABLE_HEAD = [
  ...
  { id: 'userdetails', label: 'User Details', alignRight: false },
  { id: 'stationdetails', label: 'Station Details', alignRight: false },
  { id: 'chargepolicy', label: 'Charge Policy', alignRight: false },
  { id: 'orderdetails', label: 'Order Details', alignRight: false },
...
export default function UserOrderTable() {
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ borderRadius: 4, margin: 0, textAlign: 'center' }}> Order List</p>
      </div>
