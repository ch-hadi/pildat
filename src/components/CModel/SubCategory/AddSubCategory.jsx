...
const AddSubCategory = (props) => {
  ...
  const handleAdd = () => {
    ...
    Api.post(`/sub_categories/`,finalData).then((res)=>{
      if(res.data.success){
        props.recall();
        props.setOpen(false);
      }
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ borderRadius: 4, margin: 0, textAlign: 'center' }}> Add Subcategory</p>
      </div>
      <div
        style={{
          marginTop: 10,
      ...
      >
        <CTextField  onChange={onChangeHandler} name="sub_category_name" full={true} label="Sub Category Name" margin="10px 0px" width="100%" />
        <CSelect
          width="48%"
          label="Category*"
