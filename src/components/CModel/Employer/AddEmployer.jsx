...
const AddEmployer = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ borderRadius: 4, margin: 0, textAlign: 'center' }}> Add Employer</p>
      </div>
      <div
        style={{
          marginTop: 10,
      ...
      >
        ...
        {/* <CTextField name="position_name" full={true} label="Employer Short Name" margin="10px 0px" width="100%" /> */}
        <CSelect
          width="48%"
          label="Status*"
          data={statusData}
